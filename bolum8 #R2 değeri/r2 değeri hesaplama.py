...
plt.show()
#%% Random Forest R square değeri
from sklearn.metrics import r2_score

print(r2_score(Y,rf_reg.predict(X)))
print(r2_score(Y,rf_reg.predict(k)))
print(r2_score(Y,rf_reg.predict(z)))
#%% R2 score karşılaştırma 

print("*******************************")

print("lineer regresyon r2 değeri : ",r2_score(Y,lr.predict(x)))

print("\n polinomal regresyon r2 değeri : ",r2_score(Y,lr2.predict(pr.fit_transform(X))))

print("\n support vector regresyon r2 değeri : ",r2_score(y_olcekli,svrReg.predict(x_olcekli)))

print("\n decision tree regresyon r2 değeri : ",r2_score(Y,r_dt.predict(X)))

print("\n random forest regresyon r2 değeri : ",r2_score(Y,rf_reg.predict(X))) 
